...
// Spotify beat/bar/section grid (0.9.10). Sent once per track via
// { type: 'sync' } - NOT per frame (it is kilobytes) - and handed to every
// frame callback as f.sync (null when unavailable; fall back to f.onset).
var lastSync = null;
var binCache = {};
