...
// ─────────────────────────────────────────────────────────────────
export function VizStarfield({ accent, accent2, spectrumRef, sensitivity = 1, smoothing = 0 }: VizProps) {
...
// ─────────────────────────────────────────────────────────────────
export function VizPerlinFlow({ accent, accent2, spectrumRef, sensitivity = 1, smoothing = 0 }: VizProps) {
  const ref = useRef<HTMLCanvasElement | null>(null);
  useEffect(() => {
    const canvas = ref.current;
    if (!canvas) return;
...
// ─────────────────────────────────────────────────────────────────
export function VizOrbital({ accent, accent2, spectrumRef, sensitivity = 1, smoothing = 0 }: VizProps) {
  const ref = useRef<HTMLCanvasElement | null>(null);
  useEffect(() => {
    const canvas = ref.current;
    if (!canvas) return;
...
// ─────────────────────────────────────────────────────────────────
export function VizAurora({ accent, accent2, spectrumRef, sensitivity = 1, smoothing = 0 }: VizProps) {
  const ref = useRef<HTMLCanvasElement | null>(null);
  useEffect(() => {
    const canvas = ref.current;
    if (!canvas) return;
...
export function VizCityEqualizer({ accent, accent2, spectrumRef, sensitivity = 1, smoothing = 0 }: VizProps) {
  const ref = useRef<HTMLCanvasElement | null>(null);
  useEffect(() => {
    const canvas = ref.current;
    if (!canvas) return;
...
// ─────────────────────────────────────────────────────────────────
export function VizStrings({ accent, accent2, spectrumRef, sensitivity = 1, smoothing = 0 }: VizProps) {
  const ref = useRef<HTMLCanvasElement | null>(null);
  useEffect(() => {
    const canvas = ref.current;
    if (!canvas) return;
...
// ─────────────────────────────────────────────────────────────────
export function VizHUD({ accent, accent2, spectrumRef, sensitivity = 1, smoothing = 0 }: VizProps) {
  const ref = useRef<HTMLCanvasElement | null>(null);
  useEffect(() => {
    const canvas = ref.current;
    if (!canvas) return;
...
// ─────────────────────────────────────────────────────────────────
export function VizLiquid({ accent, accent2, spectrumRef, sensitivity = 1, smoothing = 0 }: VizProps) {
  const ref = useRef<HTMLCanvasElement | null>(null);
  useEffect(() => {
    const canvas = ref.current;
    if (!canvas) return;
...
// ─────────────────────────────────────────────────────────────────
export function VizCassette({ accent, accent2, spectrumRef, sensitivity = 1, smoothing = 0 }: VizProps) {
  const ref = useRef<HTMLCanvasElement | null>(null);
  useEffect(() => {
    const canvas = ref.current;
    if (!canvas) return;
...
// ─────────────────────────────────────────────────────────────────
export function VizConstellation({ accent, accent2, spectrumRef, sensitivity = 1, smoothing = 0 }: VizProps) {
  const ref = useRef<HTMLCanvasElement | null>(null);
  useEffect(() => {
    const canvas = ref.current;
    if (!canvas) return;
