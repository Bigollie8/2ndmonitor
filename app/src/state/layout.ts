...
export type TileType = 'discord' | 'spotify' | 'claude' | 'notes' | 'mixer' | 'sysmon' | 'clock' | 'viz' | 'streamDeck' | 'weatherRadar' | 'pomodoro' | 'sun';
...
export const ALL_TILE_TYPES: TileType[] = [
  'viz', 'spotify', 'discord', 'claude', 'mixer', 'notes', 'sysmon', 'clock', 'streamDeck', 'weatherRadar', 'pomodoro', 'sun',
];
